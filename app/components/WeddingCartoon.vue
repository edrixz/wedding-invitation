...
<template>
  ...
  >
    ...
    >
      <div
        class="absolute top-6 left-6 w-12 h-12 border-t-4 border-l-4 border-[#8B4513]/40 rounded-tl-lg"
      ></div>
      <div
        class="absolute top-6 right-6 w-12 h-12 border-t-4 border-r-4 border-[#8B4513]/40 rounded-tr-lg"
      ></div>
      <div
        class="absolute bottom-6 left-6 w-12 h-12 border-b-4 border-l-4 border-[#8B4513]/40 rounded-bl-lg"
      ></div>
      <div
        class="absolute bottom-6 right-6 w-12 h-12 border-b-4 border-r-4 border-[#8B4513]/40 rounded-br-lg"
      ></div>
      ...
      >
        <div>
          <p class="text-xs md:text-sm uppercase tracking-[2px] mb-1 font-bold">
            Trân trọng kính mời
          </p>
          <h2 class="text-sm md:text-base italic">
            Tới dự lễ Vu Quy của hai con chúng tôi
          </h2>
        </div>

        <div
          class="text-4xl md:text-6xl text-[#b8860b] leading-tight py-1 font-patrick font-bold"
        >
          Phương Huyền <br />
        ...
        <div
          class="w-full border-y-2 border-[#b8860b]/30 py-3 bg-[#b8860b]/10 rounded-lg"
        >
          <div class="mb-2 border-b border-[#b8860b]/20 pb-2">
            <div
              class="text-3xl md:text-5xl font-bold text-[#7f1d1d] tracking-widest font-patrick"
            >
              22 . 02 . 2026
            </div>
            <p
              class="text-[10px] md:text-xs uppercase tracking-widest font-bold mt-1"
            >
          ...
          <div class="flex flex-col space-y-2 mt-3 px-4">
            <div class="flex justify-between items-center">
              <div class="flex items-center space-x-2">
                ...
                <span class="font-bold text-sm md:text-base uppercase"
        ...
        <div>
          <p class="font-bold uppercase text-[#3e2723] text-xs md:text-sm mb-1">
            Tại Tư Gia Nhà Gái
          </p>
        ...
        <div
          class="w-full grid grid-cols-2 gap-4 text-[10px] md:text-xs uppercase tracking-wide border-t-2 border-[#b8860b]/30 pt-3 opacity-80"
        >
          <div class="text-left">
    ...
    >
      ...
      <div
        class="cover-content relative z-30 w-full pt-12 md:pt-16 px-4 flex flex-col items-center"
      >
        <img
      ...
      >
        ...
        >
          <svg
            ...
            stroke-width="4"
            stroke="#3E2723"
            class="w-[4vh] h-[4vh] animate-pulse"
          >
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
